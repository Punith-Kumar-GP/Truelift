                  ...
                  {userPreCampaignRange && (
                    <div
                      ...
                      style={{
                        ...
                        width: `${
                          ((userPreCampaignRange.end - userPreCampaignRange.start) /
                            (preCampaignRange.end - preCampaignRange.start)) *
                          100
                        }%`,
                        borderRight: userCampaignRange.start.getTime() === new Date(userPreCampaignRange.end.getTime() + 24 * 60 * 60 * 1000).getTime() ? "none" : "2.5px dashed rgba(0, 0, 255, 0.5)",
                        borderTopRightRadius: userCampaignRange.start.getTime() === new Date(userPreCampaignRange.end.getTime() + 24 * 60 * 60 * 1000).getTime() ? "none" : "3px" ,
                        borderBottomRightRadius: userCampaignRange.start.getTime() === new Date(userPreCampaignRange.end.getTime() + 24 * 60 * 60 * 1000).getTime() ? "none" : "3px" ,
                      }}
                    ></div>
                  )}
                </div>
                  ...
                  {userCampaignRange && (
                    <div
                      ...
                      style={{
                        ...
                        width: `${
                          ((userCampaignRange.end - userCampaignRange.start) /
                            (campaignRange.end - campaignRange.start)) *
                          100
                        }%`,
                        
                        borderLeft: userCampaignRange.start.getTime() === new Date(userPreCampaignRange.end.getTime() + 24 * 60 * 60 * 1000).getTime() ? "none" : "2.5px dashed rgba(0, 0, 255, 0.5)", 
                        borderTopLeftRadius: userCampaignRange.start.getTime() === new Date(userPreCampaignRange.end.getTime() + 24 * 60 * 60 * 1000).getTime() ? "none" : "3px" ,
                        borderBottomLeftRadius: userCampaignRange.start.getTime() === new Date(userPreCampaignRange.end.getTime() + 24 * 60 * 60 * 1000).getTime() ? "none" : "3px" ,
                      }}
                    ></div>
                  )}
                </div>
